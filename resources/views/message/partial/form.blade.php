...
<div class="content msg-content">
    ...
    <div class="form-group row">
        ...
        <textarea class="input-box msg-content required form-control" type="text" name="content"
                   value="{{ old('content') }}" placeholder="{{ __('content') }}" required>
    </textarea>
    </div>
    <div class="form-group row">
        <span class="label-input">{{ __('Privacy') }}</span>
        <input type="radio" name="isPrivate" value="0" class="form-control " checked="checked">{{__('Public')}}
        <input type="radio" name="isPrivate" value="1" class="form-control">{{__('Private')}}
    </div>
